...
import warnings
warnings.warn(
    "plugin_manager_dialog.py 已被废弃，请使用 plugin_manager_dialog_unified.py 中的 PluginManagerDialogUnified",
    DeprecationWarning,
    stacklevel=2
)
...
class PluginManagerDialog(BaseDialog):
    """插件管理主界面对话框"""
    ...
    def __init__(self, plugin_manager: PluginManager, parent=None):
        super().__init__(
            ...
            min_size=(1000, 700),
            settings_key="PluginManagerDialog",
            modal=True
        )
        self.plugin_manager = plugin_manager
