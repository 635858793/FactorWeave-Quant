...
# -*- coding: utf-8 -*-
"""
测试 metric_card 和 performance_chart 导入
"""
...
def test_components_import():
    """测试 metric_card 和 performance_chart 导入"""
    logger.info("=" * 80)
    logger.info("测试 metric_card 和 performance_chart 导入")
    logger.info("=" * 80)
...
if __name__ == "__main__":
    success = test_components_import()
