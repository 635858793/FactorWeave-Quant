...
def test_async_workers_import():
    """测试async_workers导入"""
    logger.info("=" * 80)
    logger.info("测试async_workers导入")
    logger.info("=" * 80)
    ...
    try:
        ...
        logger.info("4. 导入async_workers模块...")
        import gui.widgets.performance.workers.async_workers
        logger.info("✓ async_workers模块导入成功")

        logger.info("5. 导入AsyncDataSignals类...")
...
if __name__ == "__main__":
    success = test_async_workers_import()
