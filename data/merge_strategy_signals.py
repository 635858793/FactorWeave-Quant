...
print("\n[2/4] 检查源数据...")
db_src = UnifiedSQLiteAccess.get_instance(src_db)
with db_src.get_connection() as conn_src:
    ...
    print("\n[3/4] 合并数据到目标数据库...")
    db_dst = UnifiedSQLiteAccess.get_instance(dst_db)
    with db_dst.get_connection() as conn_dst:
