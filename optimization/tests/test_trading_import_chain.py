...
# 测试3: 导入 core.trading.order_models
try:
    print("\n3. 导入 core.trading.order_models...")
    from core.trading.order_models import Order, OrderStatus
    print("✓ core.trading.order_models 导入成功")
except Exception as e:
    print(f"✗ core.trading.order_models 导入失败: {e}")

# 测试4: 导入 core.trading.trading_types
try:
    print("\n4. 导入 core.trading.trading_types...")
    from core.trading.trading_types import ExecutionResult, ExecutionStatus, TradingInterface
    print("✓ core.trading.trading_types 导入成功")
except Exception as e:
    print(f"✗ core.trading.trading_types 导入失败: {e}")

# 测试5: 导入 core.trading.interfaces.ctp_config
try:
    print("\n5. 导入 core.trading.interfaces.ctp_config...")
    from core.trading.interfaces.ctp_config import CTPConfig, get_ctp_config
    print("✓ core.trading.interfaces.ctp_config 导入成功")
except Exception as e:
    print(f"✗ core.trading.interfaces.ctp_config 导入失败: {e}")

# 测试6: 导入 core.trading.interfaces.ctp_trading_interface
try:
    print("\n6. 导入 core.trading.interfaces.ctp_trading_interface...")
